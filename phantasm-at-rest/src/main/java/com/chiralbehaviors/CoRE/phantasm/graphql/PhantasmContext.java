 ...
 *
 */
abstract public class PhantasmContext extends PhantasmCRUD {
    ...
    private static final Logger log = LoggerFactory.getLogger(PhantasmContext.class);

    public static Product getWorkspace(DataFetchingEnvironment env) {
        return ((PhantasmContext) env.getContext()).getWorkspace();
    }
    ...
    public PhantasmContext(Model model, Product workspace) {
        super(model);
