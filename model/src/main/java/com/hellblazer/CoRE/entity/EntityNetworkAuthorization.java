...
@Table(name = "entity_network_authorization", schema = "ruleform")
@SequenceGenerator(schema = "ruleform", name = "entity_network_authorization_id_seq", sequenceName = "entity_network_authorization_id_seq")
public class EntityNetworkAuthorization extends NetworkAuthorization<Entity> {
    private static final long serialVersionUID = 1L;

    //bi-directional many-to-one association to Entity
    @ManyToOne
    @JoinColumn(name = "authorized_parent")
    private Entity            authorizedParent;
    ...
    @Id
    @GeneratedValue(generator = "entity_network_authorization_id_seq", strategy = GenerationType.SEQUENCE)
    private Long              id;

    /**
     * 
     */
    public EntityNetworkAuthorization() {
        super();
    }
     ...
     * @param id
     */
    public EntityNetworkAuthorization(Long id) {
        super(id);
    }
     ...
     * @param updatedBy
     */
    public EntityNetworkAuthorization(Resource updatedBy) {
        super(updatedBy);
    }
     ...
     */
    @Override
    public Entity getAuthorizedParent() {
     ...
     */
    @Override
    public void setAuthorizedParent(Entity parent) {
