...
public interface WellKnownObject {
    ...
    public static enum WellKnownLocationContext implements WellKnownObject {
        ANY() {

            @Override
            public String description() {
                return "A special Location Context that stands for any location context";
            }
        ...
        LOCATION_CONTEXT() {
            ...
            @Override
            public String description() {
                return "The abstract notion of a 'LocationContext'";
            }
        ...
        NOT_APPLICABLE() {
            ...
            @Override
            public String description() {
                return "A special Location Context that stands for 'not applicable'";
            }
        ...
        ORIGINAL() {
            ...
            @Override
            public String description() {
                return "A special Location Context that stands for the originally supplied location context";
            }
        ...
        @Override
        public String tableName() {
            return "ruleform.location_context";
        }
    }
