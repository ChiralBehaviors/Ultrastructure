...
import static com.hellblazer.CoRE.event.status.StatusCodeNetwork.DEDUCE_NEW_NETWORK_RULES;
import static com.hellblazer.CoRE.event.status.StatusCodeNetwork.GATHER_EXISTING_NETWORK_RULES;
import static com.hellblazer.CoRE.event.status.StatusCodeNetwork.GENERATE_NETWORK_INVERSES;
import static com.hellblazer.CoRE.event.status.StatusCodeNetwork.GET_CHILDREN;
import static com.hellblazer.CoRE.event.status.StatusCodeNetwork.INFERENCE_STEP;
import static com.hellblazer.CoRE.event.status.StatusCodeNetwork.INFERENCE_STEP_FROM_LAST_PASS;
import static com.hellblazer.CoRE.event.status.StatusCodeNetwork.INSERT_NEW_NETWORK_RULES;
