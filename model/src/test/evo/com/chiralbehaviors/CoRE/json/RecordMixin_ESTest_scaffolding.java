...
public class RecordMixin_ESTest_scaffolding {

    @BeforeClass
    public static void initEvoSuiteFramework() {
        org.evosuite.runtime.RuntimeSettings.className = "com.chiralbehaviors.CoRE.json.RecordMixin";
    ...
    private static void initializeClasses() {
        org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(RecordMixin_ESTest_scaffolding.class.getClassLoader(),
                                                                               "com.chiralbehaviors.CoRE.json.RecordMixin");
    }

    private static void resetClasses() {
        org.evosuite.runtime.classhandling.ClassResetter.getInstance()
                                                        .setClassLoader(RecordMixin_ESTest_scaffolding.class.getClassLoader());
