...
@NamedQueries({
		@NamedQuery(name = FIND_CLASSIFIED_ATTRIBUTE_VALUES, query = "SELECT "
				...
				+ "       AttributeNetwork network " + "WHERE "
		...
		@NamedQuery(name = GET_CHILD, query = "SELECT rn.child "
				+ "FROM AttributeNetwork rn " + "WHERE rn.parent = :parent "
...
public class Attribute extends ExistentialRuleform<Attribute, AttributeNetwork>
	...
	public static final String GET_CHILD = "attribute" + GET_CHILDREN_SUFFIX;
	public static final String GET_CHILD_RULES_BY_RELATIONSHIP = "attribute"
			+ GET_CHILD_RULES_BY_RELATIONSHIP_SUFFIX;
	public static final String NAME_SEARCH = "attribute" + NAME_SEARCH_SUFFIX;
	public static final String UNLINKED = "attribute" + UNLINKED_SUFFIX;
	...
	public void setAttributes(
			Set<AttributeMetaAttribute> attributeMetaAttributes1) {
