...
public abstract class AttributeValue<RuleForm extends Ruleform> extends
	...
	public byte[] getBinaryValue() {
		if (attribute.getValueType() != ValueType.BINARY) {
			throw new UnsupportedOperationException(String.format(
					"May not retrieve %s value for a %s attribute",
					ValueType.BINARY, attribute.getValueType()));
		}
		return binaryValue;
	}
	...
	public Boolean getBooleanValue() {
		if (attribute.getValueType() != ValueType.BOOLEAN) {
			throw new UnsupportedOperationException(String.format(
					"May not retrieve %s value for a %s attribute",
					ValueType.BOOLEAN, attribute.getValueType()));
		}
	...
	public Integer getIntegerValue() {
		if (attribute.getValueType() != ValueType.INTEGER) {
			throw new UnsupportedOperationException(String.format(
					"May not retrieve %s value for a %s attribute",
					ValueType.INTEGER, attribute.getValueType()));
		}
		return integerValue;
	}
	...
	public BigDecimal getNumericValue() {
		if (attribute.getValueType() != ValueType.NUMERIC) {
			throw new UnsupportedOperationException(String.format(
					"May not retrieve %s value for a %s attribute",
					ValueType.NUMERIC, attribute.getValueType()));
		}
		return numericValue;
	}
	...
	public String getTextValue() {
		if (attribute.getValueType() != ValueType.TEXT) {
			throw new UnsupportedOperationException(String.format(
					"May not retrieve %s value for a %s attribute",
					ValueType.TEXT, attribute.getValueType()));
		}
		return textValue;
	}
	...
	public void setBinaryValue(byte[] binaryValue) {
		if (attribute.getValueType() != ValueType.BINARY) {
			throw new UnsupportedOperationException(String.format(
					"May not set %s value for a %s attribute",
					ValueType.BINARY, attribute.getValueType()));
		}
	...
	public void setTextValue(String textValue) {
		if (attribute.getValueType() != ValueType.TEXT) {
			throw new UnsupportedOperationException(String.format(
					"May not set %s value for a %s attribute", ValueType.TEXT,
	...
	public void setTimestampValue(Timestamp timestampValue) {
		if (attribute.getValueType() != ValueType.TIMESTAMP) {
			throw new UnsupportedOperationException(String.format(
					"May not set %s value for a %s attribute",
					ValueType.TIMESTAMP, attribute.getValueType()));
		}
