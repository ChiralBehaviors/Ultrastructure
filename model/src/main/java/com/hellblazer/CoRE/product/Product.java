...
public class Product extends ExistentialRuleform<Product, ProductNetwork>
	...
	public static final String GET_CHILD = "product" + GET_CHILD_SUFFIX;
	...
	public static final String NAME_SEARCH = "product" + NAME_SEARCH_SUFFIX;
	...
	public List<ProductNetwork> getImmediateChildren(EntityManager em) {
		return em
				.createNamedQuery(IMMEDIATE_CHILDREN_NETWORK_RULES,
						ProductNetwork.class).setParameter("product", this)
				.getResultList();
	}
