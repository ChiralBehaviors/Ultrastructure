...
import static com.chiralbehaviors.CoRE.location.access.LocationAccessAuthorization.GET_ALL_AUTHORIZATIONS_FOR_PARENT_AND_RELATIONSHIP;
...
public abstract class LocationAccessAuthorization<Child extends ExistentialRuleform<Child, ?>>
    ...
    @Override
    @JsonIgnore
    public SingularAttribute<WorkspaceAuthorization, ? extends LocationAccessAuthorization<?>> getWorkspaceAuthAttribute() {
        return null;
    }
