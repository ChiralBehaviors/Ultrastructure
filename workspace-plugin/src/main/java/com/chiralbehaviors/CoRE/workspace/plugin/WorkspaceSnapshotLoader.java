...
public class WorkspaceSnapshotLoader extends AbstractMojo {
    ...
    public WorkspaceSnapshotLoader(Configuration database, List<String> resources) {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        try {
            ...
            throw new MojoExecutionException("An error has occurred while loading snapshots", e);
        }
    }
