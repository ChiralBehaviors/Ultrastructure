...
public final class Geometry {
     ...
     */
    private strictfp static void twoProduct1Presplit(double a, double b, double bhi, double blo, Two t) {
        split(a, t);
        double ahi = t.x;
        double alo = t.y;
        t.x = a * b;
     ...
     */
    private strictfp static void twoProduct2Presplit(double a, double ahi, double alo, double b, double bhi, double blo,
                                                     Two t) {
        t.x = a * b;
        double err1 = t.x - ahi * bhi;
        double err2 = err1 - alo * bhi;
     ...
     */
    private strictfp static void twoTwoProduct(double a1, double a0, double b1, double b0, double[] x) {
