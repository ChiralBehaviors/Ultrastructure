...
import static com.hellblazer.CoRE.event.StatusCodeAttribute.GET_ATTRIBUTE;
...
public class StatusCodeAttribute extends AttributeValue<StatusCode> {
    ...
    public StatusCodeAttribute(Attribute attribute, String value, Agency updatedBy) {
        super(attribute, value, updatedBy);
    }
