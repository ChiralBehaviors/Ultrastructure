...
@Facet(classifier = @Key(name = "IsA") , classification = @Key(name = "StaticMethod") , ruleformClass = Product.class, workspace = "urn:uuid:00000000-0000-0004-0000-000000000003")
public interface StaticMethod extends ScopedPhantasm<Product> {
