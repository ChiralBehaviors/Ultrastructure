...
public class ProcessWorkflowLoader {
	...
	public void createProducts() {
		 ...
		 DEPLOY_SERVICE = new Product("Any Deploy Service", "Any deploy service", core);
	...
	public void createLocations() {
		DATA_CENTER = new Location("Data Center", "Any data center location", core);
		...
		c192_67_78_48 = new Location("c192_67_78_48", "The container located at 192.168.78.48", core);
	...
	public void createStatusCodeSequencing() {
		StatusCode[] codes = new StatusCode[]{deployed, started, failed, destroyed};
		int seqNum = model.getJobModel().createStatusCodeChain(ANY_PROCESS, codes, 1, core);
		StatusCodeSequencing failed_started = new StatusCodeSequencing(ANY_PROCESS, failed, started, ++seqNum, core);
		em.persist(failed_started);
		StatusCodeSequencing started_destroyed = new StatusCodeSequencing(ANY_PROCESS, started, destroyed, ++seqNum, core);
