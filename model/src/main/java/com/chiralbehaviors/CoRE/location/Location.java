...
public class Location extends ExistentialRuleform<Location, LocationNetwork>
	...
	public static final String GET_CHILD = "location" + GET_CHILDREN_SUFFIX;
	...
	public static final String NAME_SEARCH = "location" + NAME_SEARCH_SUFFIX;
