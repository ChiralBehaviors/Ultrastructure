...
public class Interval extends ExistentialRuleform<Interval, IntervalNetwork>
	 ...
	 * 
	 * @see
	 * com.hellblazer.CoRE.network.Networked#addChildRelationship(com.hellblazer
	 ...
	 * 
	 * @see
	 * com.hellblazer.CoRE.network.Networked#addParentRelationship(com.hellblazer
	 * .CoRE.network.NetworkRuleform)
	 */
	@Override
	...
	public List<IntervalNetwork> getImmediateChildren(EntityManager em) {
		return em
				.createNamedQuery(IMMEDIATE_CHILDREN_NETWORK_RULES,
						IntervalNetwork.class).setParameter("interval", this)
				.getResultList();
	}
	 ...
	 * 
	 * @see
	 * com.hellblazer.CoRE.attribute.Attributable#setAttributes(java.util.Set)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.hellblazer.CoRE.network.Networked#setNetworkByChild(java.util.Set)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.hellblazer.CoRE.network.Networked#setNetworkByParent(java.util.Set)
	 */
	@Override
