...
public class Agency extends ExistentialRuleform<Agency, AgencyNetwork>
	...
	public static final String FIND_ALL = "agency" + Ruleform.FIND_ALL_SUFFIX;
	public static final String FIND_BY_NAME = "agency" + FIND_BY_NAME_SUFFIX;
	...
	public static final String GET_CHILD = "agency" + GET_CHILDREN_SUFFIX;
	...
	public static final String UNLINKED = "agency" + UNLINKED_SUFFIX;
	...
	public List<ProductNetwork> getQualifiedEntityNetworkRules(EntityManager em) {
		return em
				.createNamedQuery(QUALIFIED_ENTITY_NETWORK_RULES,
						ProductNetwork.class).setParameter("agency", this)
				.getResultList();
	}
