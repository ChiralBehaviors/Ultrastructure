 ...
 */
@Entity
@Table(name = "agency_location_grouping", schema = "ruleform")
public class AgencyLocationGrouping
        extends AgencyGrouping<Location, LocationNetwork> {
    ...
    public SingularAttribute<WorkspaceAuthorization, ? extends Ruleform> getWorkspaceAuthAttribute() {
        return WorkspaceAuthorization_.agencyLocationGrouping;
    }
