...
@NamedQueries({
		...
		@NamedQuery(name = FIND_CLASSIFIED_ATTRIBUTE_VALUES, query = "SELECT "
				...
				+ "       CoordinateNetwork network " + "WHERE "
		...
		@NamedQuery(name = GET_CHILD, query = "SELECT n.child "
				+ "FROM CoordinateNetwork n " + "WHERE n.parent = :p "
				+ "AND n.relationship = :r"),
		@NamedQuery(name = GET_ALL_PARENT_RELATIONSHIPS, query = "SELECT n "
				+ "FROM CoordinateNetwork n " + "WHERE n.child = :c"),
...
public class Coordinate extends
	...
	public static final String GET_CHILD = "coordinate" + GET_CHILDREN_SUFFIX;
	...
	public static final String UNLINKED = "coordinate" + UNLINKED_SUFFIX;
	...
	public List<CoordinateAttribute> getOrderedAttributes(EntityManager em) {
		return em
				.createNamedQuery(ORDERED_ATTRIBUTES, CoordinateAttribute.class)
				.setParameter("coordinate", this).getResultList();
	}
	...
	public Coordinate nestCoordinates(EntityManager em, Coordinate outer) {
		return em.createNamedQuery(NESTING_QUERY, Coordinate.class)
				.setParameter("inner", this).setParameter("outer", outer)
				.getSingleResult();
	}
