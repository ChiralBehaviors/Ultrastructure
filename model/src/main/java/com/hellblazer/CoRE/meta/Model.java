...
public interface Model {
    String FIND_BY_NAME_SUFFIX   = ".findByName";
    String NAME_SEARCH_SUFFIX    = ".namesearch";
    String GET_UPDATED_BY_SUFFIX = ".getUpdatedBy";
    String FIND_BY_ID_SUFFIX     = ".findById";
    String FIND_FLAGGED_SUFFIX   = ".findFlagged";
     ...
     * @return
     */
    <RuleForm extends Ruleform> List<RuleForm> findUpdatedBy(Resource updatedBy,
                                                             Class<Ruleform> ruleform);
