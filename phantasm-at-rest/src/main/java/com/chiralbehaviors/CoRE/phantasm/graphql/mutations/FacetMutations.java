...
public interface FacetMutations {
    ...
    @GraphQLField
    Facet createFacet(@NotNull @GraphQLName("state") FacetState state,
                      DataFetchingEnvironment env);

    @GraphQLField
    Boolean deleteFacet(@NotNull @GraphQLName("id") UUID id,
                        DataFetchingEnvironment env);

    @GraphQLField
    Facet updateFacet(@NotNull @GraphQLName("state") FacetUpdateState state,
                      DataFetchingEnvironment env);
}
