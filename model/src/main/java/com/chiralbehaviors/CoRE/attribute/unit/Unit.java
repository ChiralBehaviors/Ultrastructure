...
@NamedQueries({
		@NamedQuery(name = FIND_CLASSIFIED_ATTRIBUTE_VALUES, query = "SELECT "
				+ "  attrValue " + "FROM " + "       UnitAttribute attrValue, "
				+ "       UnitAttributeAuthorization auth, "
				+ "       UnitNetwork network " + "WHERE "
		...
		@NamedQuery(name = GET_CHILD, query = "SELECT rn.child "
				+ "FROM UnitNetwork rn " + "WHERE rn.parent = :parent "
...
@NamedNativeQueries({
		@NamedNativeQuery(name = UNLINKED, query = "SELECT unlinked.* "
				+ "FROM attribute AS unlinked " + "JOIN (" + "SELECT id "
				+ "FROM attribute " + "EXCEPT ("
				+ "SELECT distinct(net.child) " + "FROM unit_network as net "
...
public class Unit extends ExistentialRuleform<Unit, UnitNetwork> {
	...
	public static final String GET_CHILD = "unit" + GET_CHILDREN_SUFFIX;
	public static final String GET_CHILD_RULES_BY_RELATIONSHIP = "unit"
			+ GET_CHILD_RULES_BY_RELATIONSHIP_SUFFIX;
	public static final String NAME_SEARCH = "unit" + NAME_SEARCH_SUFFIX;
	public static final String UNLINKED = "unit" + UNLINKED_SUFFIX;
