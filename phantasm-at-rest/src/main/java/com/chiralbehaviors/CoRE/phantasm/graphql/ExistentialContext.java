...
public class ExistentialContext extends WorkspaceContext {
    ...
    @Override
    public Boolean removeAgency(String id, DataFetchingEnvironment env) {
        resolve(env, UUID.fromString(id)).delete();
        return true;
    }

    @Override
    public Boolean removeAttribute(String id, DataFetchingEnvironment env) {
        resolve(env, UUID.fromString(id)).delete();
        return true;
    }

    @Override
    public Boolean removeInterval(String id, DataFetchingEnvironment env) {
        resolve(env, UUID.fromString(id)).delete();
        return true;
    }

    @Override
    public Boolean removeLocation(String id, DataFetchingEnvironment env) {
        resolve(env, UUID.fromString(id)).delete();
        return true;
    }

    @Override
    public Boolean removeProduct(String id, DataFetchingEnvironment env) {
        resolve(env, UUID.fromString(id)).delete();
        return true;
    }

    @Override
    public Boolean removeRelationship(String id, DataFetchingEnvironment env) {
        resolve(env, UUID.fromString(id)).delete();
        return true;
    }

    @Override
    public Boolean removeStatusCode(String id, DataFetchingEnvironment env) {
        resolve(env, UUID.fromString(id)).delete();
        return true;
    }

    @Override
    public Boolean removeUnit(String id, DataFetchingEnvironment env) {
        resolve(env, UUID.fromString(id)).delete();
        return true;
    }
    ...
    @Override
    public List<Agency> agencies(@GraphQLName("ids") List<String> ids,
                                 DataFetchingEnvironment env) {
        if (ids == null) {
    ...
    @Override
    public Agency agency(String id, DataFetchingEnvironment env) {
        ExistentialRecord resolved = resolve(env, UUID.fromString(id));
        return ctx(env).checkRead(resolved) ? new Agency(resolved) : null;
    }

    @Override
    public Attribute attribute(String id, DataFetchingEnvironment env) {
        ExistentialRecord resolved = resolve(env, UUID.fromString(id));
        return ctx(env).checkRead(resolved) ? new Attribute(resolved) : null;
    }

    @Override
    public List<Attribute> attributes(@GraphQLName("ids") List<String> ids,
                                      DataFetchingEnvironment env) {
        if (ids == null) {
    ...
    @Override
    public Interval interval(String id, DataFetchingEnvironment env) {
        ExistentialRecord resolved = resolve(env, UUID.fromString(id));
        return ctx(env).checkRead(resolved) ? new Interval(resolved) : null;
    }

    @Override
    public List<Interval> intervals(@GraphQLName("ids") List<String> ids,
                                    DataFetchingEnvironment env) {
        if (ids == null) {
    ...
    @Override
    public Location location(String id, DataFetchingEnvironment env) {
        ExistentialRecord resolved = resolve(env, UUID.fromString(id));
        return ctx(env).checkRead(resolved) ? new Location(resolved) : null;
    }

    @Override
    public List<Location> locations(@GraphQLName("ids") List<String> ids,
                                    DataFetchingEnvironment env) {
        if (ids == null) {
    ...
    @Override
    public Product product(String id, DataFetchingEnvironment env) {
        ExistentialRecord resolved = resolve(env, UUID.fromString(id));
        return ctx(env).checkRead(resolved) ? new Product(resolved) : null;
    }

    @Override
    public List<Product> products(@GraphQLName("ids") List<String> ids,
                                  DataFetchingEnvironment env) {
        if (ids == null) {
    ...
    @Override
    public Relationship relationship(String id, DataFetchingEnvironment env) {
        ExistentialRecord resolved = resolve(env, UUID.fromString(id));
        return ctx(env).checkRead(resolved) ? new Relationship(resolved) : null;
    }

    @Override
    public List<Relationship> relationships(@GraphQLName("ids") List<String> ids,
                                            DataFetchingEnvironment env) {
        if (ids == null) {
    ...
    @Override
    public StatusCode statusCode(String id, DataFetchingEnvironment env) {
        ExistentialRecord resolved = resolve(env, UUID.fromString(id));
        return ctx(env).checkRead(resolved) ? new StatusCode(resolved) : null;
    }

    @Override
    public List<StatusCode> statusCodes(@GraphQLName("ids") List<String> ids,
                                        DataFetchingEnvironment env) {
        if (ids == null) {
    ...
    @Override
    public Unit unit(String id, DataFetchingEnvironment env) {
        ExistentialRecord resolved = resolve(env, UUID.fromString(id));
        return ctx(env).checkRead(resolved) ? new Unit(resolved) : null;
    }

    @Override
    public List<Unit> units(@GraphQLName("ids") List<String> ids,
                            DataFetchingEnvironment env) {
        if (ids == null) {
